...
fixed point of applying the theory of processes to
itself. Symbolically, let $\Pi[X]$ denote the theory of processes
...
the fixed point of the equation: $\mathcal{R} =
\Pi[\quotep{\mathcal{R}}]$. This equation captures exactly the kind of
...
another \ref{appendix:ccomb}. This organization allows us to focus on
