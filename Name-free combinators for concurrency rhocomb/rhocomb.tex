...
properties of computations, including race conditions, and security
leaks. We want to test the limits of our algorithm. In particular, we
would like to apply the algorithm to a model of computation that
enjoys the most advanced features of computation today. For us, this
means mobile concurrency, as evinced in models of computation like the
{\pic} or the {\rhoc}
