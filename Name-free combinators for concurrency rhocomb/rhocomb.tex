...
\NYnote{You often put the citations before . -- please do not do. I correced.}
However, all such models
...
\cite{DBLP:journals/tcs/Yoshida02}
\NYnote{Here error}
While our algorithm can handle
