...
& & & \mbox{     $q_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(n_{1},n_{2})}{\mathsf{m}(q,\quotep{\mathsf{m}(v,w)})})}$ }\\
  (IV)&\meaningof{\mathsf{for}(x \leftarrow a)\mathsf{*}P}_{4}(n, q) &:=& \binpar{\meaningof{\prefix{p}{c}{(\mathsf{fw}(a,p) | R)}}_4(n,p)}{\mathsf{m}(a,n)}\\
  &&& \mbox{where $R = \mathsf{m}(x, \quotep{\binpar{\meaningof{\prefix{n}{n'}{\prefix{p}{p'}{Q}}}_4}{\binpar{D(x,v,w)}{\binpar{\mathsf{m}(n, n^r)}{\mathsf{m}(p, p^r)}}}})$} \\
  &&& \mbox{      $Q = \meaningof{\mathsf{for}(x \leftarrow c)(P | \mathsf{m}(c,x))}_{4}(n^{r},p^{r})$} \\
  &&& \mbox{      $x = @(\meaningof{P}_2(n,p))^{ll},$} \\ 
  &&& \mbox{      $v = @(\meaningof{P}_2(n,p))^{lr},$} \\
  &&& \mbox{      $w = @(\meaningof{P}_2(n,p))^{rl},$ and } \\
  &&& \mbox{      $c = @(\meaningof{P}_2(n,p))^{rr}$} \\
