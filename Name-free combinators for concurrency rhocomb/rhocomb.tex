...
\[\begin{array}{lcl}
    ...
    & = & \mathsf{m}(x, \quotep{\binpar{\meaningof{\prefix{n}{n'}{\prefix{p}{p'}{\meaningof{P}_2(n',p')}}}_4}{\binpar{D(x,v,w)}{\binpar{\mathsf{m}(n^l, n^l)}{\mathsf{m}(p^l, p^l)}}}}) \\
...
& & & \mbox{     $q_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(n_{1},n_{2})}{\mathsf{m}(q,\quotep{\mathsf{m}(v,w)})})}$ }\\
  ...
  &&& \mbox{where $R = \mathsf{m}(x, \quotep{\binpar{\meaningof{\prefix{n}{n'}{\prefix{p}{p'}{Q}}}_4}{\binpar{D(x,v,w)}{\binpar{\mathsf{m}(n^r, n^r)}{\mathsf{m}(p^r, p^r)}}}})$} \\
  &&& \mbox{      $Q = \meaningof{\mathsf{for}(x \leftarrow c)(P | \mathsf{m}(c,x))}_{4}(n^{r},p^{r})$} \\
  &&& \mbox{      $x = @(\meaningof{P}_2(n,p))^{ll},$} \\ 
  &&& \mbox{      $v = @(\meaningof{P}_2(n,p))^{lr},$ and } \\
  &&& \mbox{      $w = @(\meaningof{P}_2(n,p))^{rr}$} \\
