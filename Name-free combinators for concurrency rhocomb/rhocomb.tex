...
for all but $\mathsf{new}$ and replication.
\[\begin{array}{ccc}
& \meaningof{\pzero}_2 (n,p) = \pzero \quad\quad \meaningof{\emph{c}(\vect{a})}_2 (n,p) = \emph{c}(\vect{a}) \quad\quad \meaningof{\binpar{P}{Q}}_2 (n,p)  =  \binpar{\meaningof{P}_2 (n^l, p^l)}{\meaningof{Q}_2 (n^r, p^r)} & \\
& \meaningof{(\new \; x ) P}_2 (n, p) = \binpar{\meaningof{\prefix{p}{x}{{\meaningof{P}_2 ( n^l, p^l )}}}_4(n, p)}{\mathsf{m}(p, n)} &
\end{array}\]
...
\[\begin{array}{lcl}
    ...
    %          & = & \binpar{\mathsf{m}(x, \quotep{\meaningof{P}_3(n^r,p^r,x,v,w)})}
    % \meaningof{\prefix{n}{n'}{\prefix{p}{p'}{(\binpar{\meaningof{P}_2(n',p')}{D(x,v,w)})}}}_4
    & = & \mathsf{m}(x, \quotep{\binpar{\meaningof{\prefix{n}{n'}{\prefix{p}{p'}{\meaningof{P}_2(n',p')}}}_4}{\binpar{D(x,v,w)}{\binpar{\mathsf{m}(n, n^l)}{\mathsf{m}(p, p^l)}}}}) \\
    &   &  |\; \binpar{D(x,v,w)}{\binpar{\mathsf{m}(n, n^l)}{\mathsf{m}(p, p^l)}} \\
                  & & \mbox{where } 
...
& & & \mbox{where $v = \quotep{(\mathsf{m}(q,\quotep{\binpar{\mathsf{b}_{\mathsf{l}}(q,n)}{\binpar{\meaningof{P}}{\meaningof{Q}}}}))}$,} \\
& & & \mbox{     $w = \quotep{(\mathsf{m}(q,\quotep{\binpar{\mathsf{b}_{\mathsf{r}}(q,n)}{\binpar{\meaningof{P}}{\meaningof{Q}}}}))}$,} \\
& & &\mbox{     $n_{1} = \quotep{(\binpar{\mathsf{b}_{\mathsf{l}}(v,w)}{\mathsf{m}(n,\quotep{\mathsf{m}(v,w)})})}$,} \\
& & &\mbox{     $n_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(v,w)}{\mathsf{m}(n,\quotep{\mathsf{m}(v,w)})})}$,} \\
...
& & & \mbox{     $q_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(n_{1},n_{2})}{\mathsf{m}(q,\quotep{\mathsf{m}(v,w)})})}$ }\\
  (IV)&\meaningof{\mathsf{for}(x \leftarrow a)\mathsf{*}P}_{4}(n, q) &:=& \binpar{\meaningof{\prefix{q}{c}{(\mathsf{fw}(a,q) | R)}}_4(n,q)}{\mathsf{m}(a,n)}\\
  &&& \mbox{where $R = \mathsf{m}(x, \quotep{\binpar{\meaningof{\prefix{n}{n'}{\prefix{q}{q'}{Q}}}_4}{\binpar{D(x,v,w)}{\binpar{\mathsf{m}(n, n^r)}{\mathsf{m}(q, q^r)}}}})$} \\
  &&& \mbox{      $Q = \meaningof{\mathsf{for}(x \leftarrow c)(P | \mathsf{m}(c,x))}_{4}(n^{r},q^{r})$} \\
  &&& \mbox{      $x = @(\meaningof{P}_2(n,q))^{ll},$} \\ 
  &&& \mbox{      $v = @(\meaningof{P}_2(n,q))^{lr},$} \\
  &&& \mbox{      $w = @(\meaningof{P}_2(n,q))^{rl},$ and } \\
  &&& \mbox{      $c = @(\meaningof{P}_2(n,q))^{rr}$} \\
