...
%% Types
%% \tau ::=  T | \tau \rhd \tau | S | K | I | {} | R\tau | (\tau \tau) | \tau \cup \tau | \sigma\bindnasrepma(\tau,\tau,\tau,\tau,\tau,\tau) | \sigma\oplus(\tau,\tau,\tau) | (kappa versions of \bindnasrepma\oplus)

%% We use the abbreviations
%% \sigma\otimes(A,B,C) ≜ (((S A\rhd B\rhd C) A\rhd B) A) 
%% \sigma&(A,B,C,C') ≜ (((S A\rhd B\rhd C' \rhd C) A\rhd B) A) 
...
%% ---------------------------------------------- \sigma with
%% \Gamma, \Delta, \Xi \vdash (((S x) y) z): \sigma&(A,B,C',C)
