...
$App( \boxempty : \tau \rhd l_{\mathsf{K}}, \boxempty : \tau )$
...
\begin{itemize}
  ...
  \item $\mathsf{K}_{\boxempty\boxempty} : \chi^{\circ} \times \chi^{\bullet} \rightarrow \chi^{\circ\bullet}$
...
\begin{mathpar}
  ...
  \inferrule* [lab=leftarrow] {\vdash \Gamma, \boxempty : \tau , \chi : \tau'} {\vdash \Gamma, \chi! : \tau' \lhd \tau}
