...
\begin{mathpar}
  ...
  \inferrule* [lab=$\rho^{l}_{\rightarrow}$]{\Gamma, \boxempty : \tau \vdash \mathsf{t}( \rho( t, \boxempty ) ) : \tau' }{\Gamma \vdash !\mathsf{K}( t, \boxempty ) : \tau \rhd \tau'} \\
  \inferrule* [lab=$\rho^{r}_{\rightarrow}$]{\Gamma, \boxempty : \tau \vdash \mathsf{t}( \rho( \boxempty, u ) ) : \tau' }{\Gamma \vdash \mathsf{K}( \boxempty, u )! : \tau \lhd \tau'}
\end{mathpar}
...
%% --------------------------------------------------------------------------------------------
%% |- R( K( k( x ), m( x, a ) ) ) : hat( 0 )
\inferrule* [lab=cut] {\inferrule* [lab=$\rho^{l}$]{\inferrule* [lab=weakening] {\inferrule* [lab=axiom] {} {\vdash 0 : \hat{0}}} {\boxempty : \hat{m}( x, T ) \vdash 0 : \hat{0}}}{\vdash !\mathsf{K}(\mathsf{k}( x ), \boxempty ) : \hat{m}( x, T ) \rhd \hat{0}} \quad \inferrule* [lab=axiom] {} {\vdash \mathsf{m}( x, a ) : \hat{m}( x, T )}} {\vdash \mathsf{R}( \mathsf{K}( \mathsf{k}( x ), \mathsf{m}( x, a ) ) ) : \hat{0}}
\end{mathpar}
