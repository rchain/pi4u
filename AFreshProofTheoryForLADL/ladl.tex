...
\begin{mathpar}
  ...
  \inferrule* [lab=$\rho^{l}_{\rightarrow}$]{\Gamma \vdash \mathsf{t}( \rho( t, u ) ) : \tau' \quad \Delta \vdash u : \tau }{\Gamma,\Delta \vdash !\mathsf{K}( t, \boxempty ) : \tau \rhd \tau'} \\
  \inferrule* [lab=$\rho^{r}_{\rightarrow}$]{\Gamma \vdash \mathsf{t}( \rho( t, u ) ) : \tau' \quad \Delta \vdash t : \tau }{\Gamma,\Delta \vdash \mathsf{K}( \boxempty, u )! : \tau \lhd \tau'}
\end{mathpar}
