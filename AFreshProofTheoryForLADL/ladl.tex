...
computational model. Examples include the {\pic}, in fact, all the
mobile process calculi, as well as the lambda calculus. However,
...
\begin{mathpar}
  ...
  \inferrule* [lab=context-cut-left] {\Gamma \vdash \mathsf{K}([],u)! : \tau' \lhd \tau,  \Delta \vdash t : \tau}{\Gamma, \Delta \vdash \mathsf{R}(\mathsf{K}(t,u)) : \mathsf{R}\tau'}

  \inferrule* [lab=context-cut-right] {\Gamma \vdash !\mathsf{K}(t,[]) : \tau \rhd \tau',  \Delta \vdash u : \tau} {\Gamma, \Delta \vdash \mathsf{R}(\mathsf{K}(t,u)) : \mathsf{R}\tau'}
\end{mathpar}
...
\begin{mathpar}
  ...
  \inferrule* [lab=$\rho_{\otimes}\perp\lhd$] {\vdash \Gamma, \mathsf{K}([],u)! : \tau' \lhd \tau,  \vdash t : \tau, \Delta } {\vdash \Gamma, \mathsf{R}(\mathsf{K}(t,u)) : \mathsf{R}\tau', \Delta}

  \inferrule* [lab=$\rho_{\otimes}\perp\rhd$] {\vdash \Gamma, !\mathsf{K}(t,[]) : \tau \rhd \tau',  \Delta \vdash u : \tau}{\vdash \Gamma, \mathsf{R}(\mathsf{K}(t,u)) : \mathsf{R}\tau', \Delta}
\end{mathpar}
