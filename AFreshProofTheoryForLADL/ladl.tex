...
\begin{mathpar}
  ...
  \inferrule* [lab=whynotright] {\vdash \Gamma^{\circ}, \blacksquare : \tau_{1}, \chi^{\circ} : \tau_{2}, \Delta^{\bullet}} {\vdash \Gamma^{\bullet}, ?\chi^{\circ}? : \tau_{1} \LHD \tau_{2}, \Delta^{\bullet}} \\

  \inferrule* [lab=leftarrow] {\vdash \Gamma, \chi^{\circ} : \tau} {\vdash \Gamma, \chi! : \tau' \lhd \tau}

  \inferrule* [lab=rightarrow] {\vdash \Gamma, \boxempty : \tau , \chi : \tau'}{\vdash \Gamma, !\chi : \tau \rhd \tau'} \\
